...
# NOTE: this is an example script for running 4 HI channels per job on the compute-canada cedar cluster.
...
# Job number determines which channel are run.
...
param_file="/home/ekoch/code/VLA_Lband/17B-162/HI/imaging/param_files/14B_17B_1kms_v2.saved"
