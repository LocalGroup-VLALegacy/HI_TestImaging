...
imagepath = os.path.join(datapath, 'BC_testimaging')

if not os.path.exists(imagepath):
    os.mkdir(imagepath)

# vis_contsub = os.path.join(datapath, 'M31_20A-346_BC_HI.ms.contsub.regrid2kms')
vis_contsub = os.path.join(datapath, 'M31_20A-346_BC_HI.ms.contsub.regrid2kms.withflagging')
...
imaging_setups = [{'weight': 'briggs', 'robust': 1., 'taper': "", 'cell': '1.2arcsec'},
    ...
    for time_match in matched_time:
        ...
        for contsub in with_contsub:
            ...
            imagename_run = os.path.join(imagepath,
                                        'M31_BC_20A_{0}_{1}_robust{2}_taper_{3}_cell_{4}.with_flagging_reweighted'
                                        .format(confs,
                                                myweight,
                                                myrobust,
